...
import com.kkulmo.bank.user.dto.*;
...
public class UserService {
    ...
    public UserCIDTO getCIbyNameAndBirth(String userName, String userBirth) {
        ...
        if (existingUser.isEmpty()) {
            throw new EntityNotFoundException("해당 이름과 생년월일로 등록된 사용자가 존재하지 않습니다.");
        }

        return UserCIDTO.builder()
                .userCI(existingUser.get().getUserId())
                .build();
    }
