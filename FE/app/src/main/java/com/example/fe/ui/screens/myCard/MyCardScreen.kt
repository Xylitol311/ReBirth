...
//    val navigatingCardPage by viewModel.selectedCardPage.collectAsState()
//    val cardsAppeared by viewModel.cardsAppeared.collectAsState()
//
//    // 카드 등장 애니메이션 시작
//    LaunchedEffect(Unit) {
//        viewModel.startCardAppearAnimation()
//    }
//
...
//        // 로딩 또는 에러 상태 표시
//        when (uiState) {
//            is MyCardViewModel.UiState.Loading -> {
//                Box(
...
//                }
//            }
//            is MyCardViewModel.UiState.Error -> {
//                Box(
//                    modifier = Modifier.fillMaxSize(),
//                    contentAlignment = Alignment.Center
//                ) {
...
//                    ) {
//                        Text(
//                            text = (uiState as MyCardViewModel.UiState.Error).message,
//                            color = Color.White,
//                            textAlign = TextAlign.Center
//                        )
//                        Spacer(modifier = Modifier.height(16.dp))
//                        Button(onClick = { viewModel.loadMyCards(true) }) {
//                            Text("다시 시도")
//                        }
//                    }
//                }
...
//                                IconButton(
//                                    onClick = {
//                                        viewModel.navigateToManageCards(onManageCardsClick)
//                                    },
//                                    modifier = Modifier
//                                        .size(36.dp)
//                                        .graphicsLayer {
...
//                                            viewModel.navigateToCardDetail(
//                                                realCards[page],
//                                                page,
//                                                onCardClick
//                                            )
